## Ansible/ServiceDiscovery. Инструменты автоматизации

### Цель: Научиться использовать Ansbile для удаленного конфигурирования машин с целью поднятия микросервиса, а также использование Consul для обнаружения сервисов и настройка sidecar proxy через Envoy для шифрования трафика  

### Стек технологий и исследуемые утилиты: docker, docker compose, ansible, vagrant, consul, envoy
